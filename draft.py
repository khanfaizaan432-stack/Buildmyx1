...
from config import (
    ...
    QUALITY_WEIGHT, TACTIC_WEIGHT,
    CHEMISTRY_SAME_CLUB, CHEMISTRY_SAME_NATION, CHEMISTRY_CAP,
)

CHEM_CLUB = CHEMISTRY_SAME_CLUB
CHEM_NATION = CHEMISTRY_SAME_NATION
CHEM_CAP = CHEMISTRY_CAP
